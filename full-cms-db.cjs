...
async function run() {
  ...
  try {
    ...
    const settings = [
      ...
      ['hero_btn2_link',        '',                             'Hero Button 2 Link',         'text',     'homepage', 6, 'Leave empty to use WhatsApp number'],
      ...
      ['tile1_color', '#FFEBEE', 'Tile 1 Background Color', 'color', 'tiles', 4, ''],
      ...
      ['tile2_color', '#E3F2FD', 'Tile 2 Background Color', 'color', 'tiles', 8, ''],
      ...
      ['tile3_color', '#E8F5E9', 'Tile 3 Background Color', 'color', 'tiles', 12, ''],
      ...
      ['tile4_color', '#FFF8E1', 'Tile 4 Background Color', 'color', 'tiles', 16, ''],
      ...
      ['delivery_slots',      '9:00 AM – 12:00 PM,12:00 PM – 3:00 PM,3:00 PM – 6:00 PM', 'Delivery Time Slots', 'textarea', 'delivery', 2, 'One per line or comma separated'],
      ...
      ['app_page_subtitle',   'Order plastic packaging materials on the go. Same-day delivery in Kanpur, pan-India shipping.', 'App Page Subtitle', 'textarea', 'app', 2, ''],
      ...
      ['login_otp_hint',      'A 6-digit OTP will be sent to your phone.', 'OTP Hint Text', 'text', 'login', 5, ''],

      // ── SEO ──────────────────────────────────────────────────────────────────
      ['seo_site_title',      'PackKart — Plastic Packaging, Delivered', 'Site Title', 'text', 'seo', 1, 'Browser tab title'],
      ['seo_description',     'Order LD Film, PP Bags, BOPP Tape, Bubble Wrap, Stretch Film and more — same-day delivery in Kanpur, pan-India shipping.', 'Meta Description', 'textarea', 'seo', 2, ''],
      ['seo_keywords',        'plastic packaging, LD film, bubble wrap, BOPP tape, Kanpur packaging', 'Keywords', 'text', 'seo', 3, ''],
      ['seo_og_image',        '',                             'OG Image URL',      'text', 'seo', 4, 'Social share image'],
